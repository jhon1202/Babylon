  ...
  return (
    <>
      <section className="pt-40 pb-24 relative">
        <header>
          <div className="flex ml-24 mr-24 gap-x-8">
            <div className="space-y-6">
              ...
              <form className="flex items-stretch gap-x-4">
                ...
                <button className="px-4 h-12 rounded-lg bg-primary-600 hover:bg-primary-700 active:bg-primary-800 hover:transition duration-150 shadow-lg hover:shadow-primary-600/50 shadow-xs text-md font-semibold text-white">
                  Request demo
                </button>
              </form>
            ...
            <div className="w-1/2 relative rounded-[10px]">
              <div className="relative border-4 border-gray-900 rounded-[10px] w-[115%] h-[80%] mt-8">
                <img
                  src={header_img}
                  alt="header"
